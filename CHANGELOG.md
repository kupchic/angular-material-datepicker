...
## [20.0.0] - 2026-04-01
### Changed
- Upgrade Angular, CDK, and Material to v20.
- Switch application builder to `@angular-devkit/build-angular:application`.
- Use `moduleResolution: "bundler"` for library and root tsconfig.
- Update timepicker icon-button CSS tokens for Material v20.
